...
function setup() {
  ...
  ruleset[0] = new Rule('B', "[MGONP]++++[MGONP]++++[MGONP]");
  // ruleset[0] = new Rule('B', "[MGONP]+++[MGONP]+++[MGONP]+++[MGONP]+++[MGONP]");
  // ruleset[0] = new Rule('B', "[MGONP]++[MGONP]++[MGONP]++[MGONP]++[MGONP]++[MGONP]");
  ruleset[1] = new Rule('N', "MEB");
  // ruleset[2] = new Rule('K', "E[-K++N]");

  // ruleset[1] = new Rule('B', "G[--H][++H]");
  // ruleset[2] = new Rule('H', "G[-H][+H]");
  lsys = new LSystem("EB", ruleset);
  turtle = new Turtle(lsys.getSentence(), 80, radians(30));
